...
class Sidebar extends MapComponent {
  ...
  onClose(e) {
    e.preventDefault();
    e.stopPropagation();
    this.props.onClose && this.props.onClose(this.props.apoClient);
  }

  onOpen(e, tabid) {
    e.preventDefault();
    e.stopPropagation();
    this.props.onOpen && this.props.onOpen(tabid,this.props.apoClient);
  }
  ...
  renderTab(tab) {
    ...
    return (
      <li className={active + disabled} key={tab.props.id}>
        <a href={'#' + tab.props.id} role="tab" onClick={e => 
      //    tab.props.disabled ?this.onClose(e): this.onOpen(e, tab.props.id)}>
       tab.props.disabled || this.onOpen(e, tab.props.id)}>
